...
python -m autopass_gen.cli generate \
  --n 50 \
  --out-dir configs/generated_50 \
  --seed 0

python -m autopass_gen.cli demo \
  --out-dir runs/demo_fixed_3

python -m autopass_gen.cli run \
  --scenario-dir configs/generated_50 \
  --out-dir runs/batch_50_deadline_fix \
